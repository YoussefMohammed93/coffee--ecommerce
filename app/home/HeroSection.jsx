  ...
  return (
    ...
    >
      ...
      <div className="relative grid grid-cols-1 md:grid-cols-2 h-full wrapper pt-[108px]">
        ...
        <div className="flex flex-col items-center md:items-start justify-center pb-10 pt-10 md:pt-0 md:pb-20 md:py-12 lg:pb-16 text-white order-2 md:order-1 text-center md:text-right">
          <div>
          ...
          <p className="text-lg lg:text-xl mt-8 mb-5">
